    ...
    return (
      ...
      <div>
       <div className='flex-l justify-end'>
         {/* {FeaturedMix} */}
         <Featuredmix {...this.state} {...this.actions} {...this.firstMix} id={firstMix.key} name={firstMix.name} pictures={firstMix.pictures}/>
         <div className='w-50-l relative z-1'>
           {/* {Header} */}
           <Header />
           {/* Router page */}
           <Route exact path='/' render={()=><Home {...this.state} {...this.actions}/>} />
           <Route path='/archieve' render={()=><Archive {...this.state} {...this.actions}/>} />
