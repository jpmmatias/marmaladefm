...
const Featuredmix = ({name ,pictures={},...props}) => {
    console.log(props)
    return (
        <div className='w-50-l vh-100 flex items-center jusify-center cover bg-center bg-featured pad-bottom fixed left-0 mix-overlay' style={{backgroundImage:`url(${pictures.extra_large})`}} >
            <PlayMix {...props} >
